...
public class T00_css_isDisplayed {
    public static void main(String[] args) {
        ...
        System.out.println("forgetPasswordHeading.get.Text()=" +forgotPasswordHeading.getText());

        //isDisplayed() boolean -will return true or false depending on the element is displayed at html
        System.out.println("forgetPasswordHeading.get.Text()=" + forgotPasswordHeading.isDisplayed());
